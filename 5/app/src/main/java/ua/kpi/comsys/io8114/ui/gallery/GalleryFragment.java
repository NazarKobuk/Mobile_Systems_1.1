package ua.kpi.comsys.io8114.ui.gallery;
...
public class GalleryFragment extends Fragment {
    ...
    static private ArrayList<ImageView> imageViews;
    static private ArrayList<ArrayList<Object>> placeholders;
    ...
    private void putImage(LinearLayout scrollMain, ArrayList<ImageView> allImages,
        ...
        newImage.setBackgroundResource(R.color.grey);
        ...
        switch (allImages.size() % 6){
            case 0:{
                ...
                Guideline vertical_20 = createGuideline(ConstraintLayout.LayoutParams.VERTICAL,
                        0.2f);
                Guideline vertical_40 = createGuideline(ConstraintLayout.LayoutParams.VERTICAL,
                        0.4f);
                Guideline vertical_60 = createGuideline(ConstraintLayout.LayoutParams.VERTICAL,
                        0.6f);

                Guideline horizontal_50 = createGuideline(ConstraintLayout.LayoutParams.HORIZONTAL,
                        0.666666f);
                Guideline horizontal_75 = createGuideline(ConstraintLayout.LayoutParams.HORIZONTAL,
                        1f);
